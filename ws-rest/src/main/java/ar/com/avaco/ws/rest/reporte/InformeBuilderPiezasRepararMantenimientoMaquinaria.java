...
public class InformeBuilderPiezasRepararMantenimientoMaquinaria extends InformeBuilder {
	...
	public InformeBuilderPiezasRepararMantenimientoMaquinaria(ActividadReporteDTO eldto, String informePath)
	...
	public ResponseEntity<JSONResponse> generarReporte() throws DocumentException, IOException {
		...
		try {
			...
			String titulo = "PIEZAS A REPARAR";
			if (dto.getTipoActividad().equals("M"))
				titulo = "MANTENIMIENTO MAQUINARIAS";
